  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Failed Project",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
      ),
    ...
    child: Text("Failed Reason",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
    ),
        SizedBox(
          height: 10,
             ...
             Padding(
               padding: const EdgeInsets.only(right: 80,left: 40,bottom: 20,top: 10),
               child: TextField(
