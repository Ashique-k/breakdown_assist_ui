...
class User_Mech_Detail extends StatefulWidget {
  const User_Mech_Detail({super.key});
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: (){}, child: Text("Activate",style: TextStyle(color: Colors.white),),
              ...
              Padding(
                ...
                child: Text("Add Needed Service",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
              ),
              SizedBox(
                height: 5,
              ),
              ...
              SizedBox(
                height: 50,
                width: 300,
                child: ElevatedButton(onPressed: (){}, child: Text("Submit",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 15),),
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.orange
                ),
